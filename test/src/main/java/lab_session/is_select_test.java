...
WebDriver driver = new ChromeDriver();
		...
		By checkboxlocator = By.className("select-all");
		WebElement ch_locator = driver.findElement(checkboxlocator);
		Thread.sleep(Duration.ofSeconds(5));
		System.out.println("Before select : "+ch_locator.isSelected());

		ch_locator.click();
		Thread.sleep(Duration.ofSeconds(5));

		System.out.println("After select : "+ch_locator.isSelected());
